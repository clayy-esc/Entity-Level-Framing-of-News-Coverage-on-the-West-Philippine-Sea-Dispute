  ...
  return (
    <main className="flex-1 bg-gray-100 dark:bg-slate-950">
      <div className="flex flex-col items-center justify-center">
        ...
        <section className="m-2 w-5/6 rounded-lg bg-white shadow-md md:w-3/5 dark:bg-slate-900">
          <button
          ...
          {openSections.section2 && (
            <div className="px-8 pb-8 text-justify">
              <p>
                ...
                illo eveniet soluta veniam recusandae, dicta animi velit totam
                necessitatibus dolore eos beatae sed ea sit aut, vitae omnis
                libero dolores a quos pariatur? Quisquam? Ipsum ipsam animi
                delectus beatae eius placeat illum odio necessitatibus,
                explicabo quia iure a hic neque pariatur vero dolore, quaerat
                esse velit laborum minus quidem enim nam. Ipsum, eaque
                excepturi?
              </p>
            </div>
          )}
        ...
        <section className="m-2 w-5/6 rounded-lg bg-white shadow-md md:w-3/5 dark:bg-slate-900">
          ...
          >
            <h2>Entity-Level Framing Classification</h2>
            <ChevronDown
              size={20}
        ...
        <section className="m-2 w-5/6 rounded-lg bg-white shadow-md md:w-3/5 dark:bg-slate-900">
          ...
          >
            <h2>Dashboard Visualization Outputs</h2>
            <ChevronDown
              size={20}
